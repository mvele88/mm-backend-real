...
async function getJupiterQuote(inputMint, outputMint, amount, slippage = 2, onlyDirectRoutes = false) { // Changed slippage to 2%
    try {
        console.log(`[JUPITER_QUOTE] Requesting quote: InputMint=<span class="math-inline">\{inputMint\}, OutputMint\=</span>{outputMint}, Amount=<span class="math-inline">\{amount\}, Slippage\=</span>{slippage}, OnlyDirectRoutes=${onlyDirectRoutes}`); // Added logging
        const response = await axios.get('https://quote-api.jup.ag/v6/quote', {
            ...
            timeout: 20000 // <--- CHANGED THIS LINE
        });
