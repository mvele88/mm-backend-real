...
async function getJupiterQuote(inputMint, outputMint, amount, slippage = 2, onlyDirectRoutes = false) { // Changed slippage to 2%
    try {
        ...
        console.log(`[JUPITER_QUOTE] Requesting quote: InputMint=<span class="math-inline">\{inputMint\}, OutputMint\=</span>{outputMint}, Amount=<span class="math-inline">\{amount\}, Slippage\=</span>{slippage}, OnlyDirectRoutes=${onlyDirectRoutes}`);
        const response = await axios.get('https://quote-api.jup.ag/v6/quote', {
            ...
            // INCREASED TIMEOUT TO 30 SECONDS (30000 ms)
            timeout: 30000 // MODIFIED LINE
        });
...
app.post('/start', async (req, res) => {
    ...
    if (!isRunning) {
        ...
        try {
            ...
            internalWalletKeypair = Keypair.from